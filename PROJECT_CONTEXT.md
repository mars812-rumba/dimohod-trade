...
- расширить `products` или добавить отдельную таблицу `product_specs`;
- для SKU оставить цены, артикулы, остатки и вариантность;
- нормализованные характеристики хранить на уровне товара или SKU в зависимости от исходной
