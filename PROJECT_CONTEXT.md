...
Миграция `backend/alembic/versions/202608050001_pipe_steel_selection_profiles.py` добавляет
подтвержденные владельцем профили внутренней стали к SKU труб. В
